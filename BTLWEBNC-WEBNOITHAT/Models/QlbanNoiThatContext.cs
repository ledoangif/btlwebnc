...
namespace BTLWEBNC_WEBNOITHAT.Models
{
    public partial class QLBanNoiThatContext : DbContext
    {
        ...
        public virtual DbSet<TBlogTag> TBlogTags { get; set; } = null!;
        ...
        public virtual DbSet<TblChiTietGioHang1> TblChiTietGioHang1s { get; set; } = null!;
        public virtual DbSet<TblCtyeuThich> TblCtyeuThiches { get; set; } = null!;
        public virtual DbSet<TblGioHang> TblGioHangs { get; set; } = null!;
        public virtual DbSet<TblYeuThich> TblYeuThiches { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LHD;Database=QLBanNoiThat;Trusted_Connection=True;;Encrypt=False;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdctyeuThich)
                    .HasName("IDCTYeuThich");
                ...
                entity.HasOne(d => d.IdchiTietSanPhamNavigation)
                    .WithMany(p => p.TblCtyeuThiches)
                    .HasForeignKey(d => d.IdchiTietSanPham)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_TblCTYeuThich_tChiTietSanPham");

                entity.HasOne(d => d.IdyeuThichNavigation)
                    .WithMany(p => p.TblCtyeuThiches)
        ...
        public DbSet<BTLWEBNC_WEBNOITHAT.ViewModels.BlogPostVM>? BlogPostVM { get; set; }
    }
}
